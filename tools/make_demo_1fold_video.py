...
def get_args():
    ...
    args.add_argument('--lr_dir', type=str, default=r"D:\videoDenoise_Real\heavyNoise\noisy")
    args.add_argument('--rec_dir', type=str, default=r"D:\videoDenoise_Real\heavyNoise\mapsv")
    args.add_argument('--save_path', type=str, default=r"D:\videoDenoise_Real\heavyNoise\result")
    args.add_argument('--fps', type=int, default=15)
    args.add_argument('--img_height', type=int, default=960)
